...
int main()
{
    ...
    do
    {
        cout << "Enter 1 to add item, 2 to change rate(price) of an item,\n"
             << " 3 to issue/recieve an item, 4 to check quantity of an item,\n"
             << " 5 to know price of an item, 0 to exit : ";
        cin >> ch;
        switch (ch)
        {
            int x, ic;
